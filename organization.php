    ...
    <section class="hero">
        <div class="container">
            <div class="hero-content">
                <div class="hero-text">
                    <h1>Organizational Strategies</h1>
                    <p class="subtitle">Transform your organizational structure to align with your long-term goals. We provide strategic planning, change management, and performance improvement services that foster a resilient and agile organization.
...
$categoryName = isset($categoryName) ? $categoryName : 'Organizational Strategy';
