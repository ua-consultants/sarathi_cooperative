...
<head>
    ...
    <title>Health Care Industry | Sarathi Cooperative</title>
...
.hero {
    padding-top: 95px;
    background: linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.1)), url('img/health-head.jpg');
...
<body>
    ...
    <div class="container">
        ...
        <p>Transforming patient care through advanced medical technologies, innovative treatments, and digital health solutions that improve lives worldwide.</p>
    </div>
</section>
...
<main class="main-content">
    ...
    <section class="section">
        <div class="container">
            ...
            <p>The healthcare industry is one of the most essential sectors globally, dedicated to improving human well-being through prevention, diagnosis, treatment, and management of diseases. It spans hospitals, clinics, pharmaceutical companies, biotechnology firms, and medical device manufacturers — all working together to enhance health outcomes and quality of life.</p>
            <div class="content-with-image">
                <div>
                    <h3>Revolution in Medicine</h3>
                    <p>With rapid advancements in genomics, artificial intelligence, telemedicine, and personalized medicine, the healthcare landscape is evolving faster than ever. Digital health platforms, robotic surgery, and wearable health devices are redefining how patients interact with the system and how providers deliver care.</p>
                    <p>Valued at over $12 trillion globally, the healthcare industry supports millions of jobs and continues to be a key driver of innovation, economic growth, and public health resilience across the world.</p>
                </div>
                <div class="image-placeholder">
                    <img src="img/doc-con.png" alt="Doctors consulting with patient">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="grid grid-3">
                <div class="card">
                    <div class="image-placeholder small-image">
                        <img src="img/hospital.svg" alt="Hospital illustration">
                    </div>
                    <h3>Hospitals & Clinics</h3>
                    <p>Acute care facilities, specialty hospitals, diagnostic centers, and outpatient clinics that provide essential medical services ranging from emergency care to long-term treatment.</p>
                </div>
                <div class="card">
                    <div class="image-placeholder small-image">
                        <img src="img/biotech.png" alt="Pharmaceutical lab image">
                    </div>
                    <h3>Pharmaceuticals & Biotechnology</h3>
                    <p>Development of life-saving drugs, vaccines, gene therapies, and precision medicines that target specific diseases and improve treatment efficacy.</p>
                </div>
                <div class="card">
                    <div class="image-placeholder small-image">
                        <img src="img/digital-health.png" alt="Digital health concept">
                    </div>
                    <h3>Digital Health & Telemedicine</h3>
                    <p>AI-powered diagnostics, remote patient monitoring, mobile health apps, and virtual consultations that expand access to care and streamline clinical workflows.</p>
                </div>
            </div>
        </div>
    </section>
...
<section class="section technologies-section">
    <div class="container">
        ...
        <div>
            <h3>Innovating Patient-Centric Care</h3>
            <p>Healthcare is experiencing rapid technological advancements that improve diagnostics, treatment, and patient outcomes. Our integrated approach to health tech enables providers, payers, and life sciences companies to deliver high-quality, cost-effective care through digital transformation and intelligent systems.</p>
        </div>
        
        <div class="tech-content-grid">
            <div class="tech-image-container">
                <div class="image-placeholder">
                    <img src="img/health-tech.png" alt="Healthcare Technology">
                </div>
            </div>
            <div class="tech-list-container">
                ...
                <ul class="feature-list">
                    ...
                    <li>Electronic Health Records (EHR) Optimization</li>
                    <li>Wearable Health Devices</li>
                    <li>Genomics and Personalized Medicine</li>
                    <li>Medical Robotics and Surgical Assistance</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <section class="section">
        <div class="container">
            ...
            <div class="grid grid-2">
                <div class="card">
                    <div class="image-placeholder">
                        <img src="img/patient-monitoring.png" alt="Patient monitoring dashboard">
                    </div>
                    <h3>Patient Monitoring Systems</h3>
                    <p>Real-time remote monitoring tools that track vital signs, detect anomalies, and alert caregivers instantly, enabling proactive intervention and better chronic disease management.</p>
                </div>
                <div class="card">
                    <div class="image-placeholder">
                        <img src="img/analysis.png" alt="Medical research lab">
                    </div>
                    <h3>Vaccine Development</h3>
                    <p>Accelerated vaccine research and manufacturing capabilities using mRNA technology, AI modeling, and global collaboration to combat pandemics and protect public health.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section">
        <div class="container">
            <h2>Future of Health Care</h2>
            <p style="text-align: center; font-size: 1.2rem; margin-bottom: 3rem; color: #495057;">Building a healthier tomorrow through innovation, inclusivity, and intelligent systems.</p>
            <div class="grid grid-3">
                <div class="card">
                    <h3>Personalized Medicine</h3>
                    <p>Advancing tailored treatments based on genetic profiling, biomarkers, and AI-driven insights that optimize therapeutic outcomes for individual patients.</p>
                </div>
                <div class="card">
                    <h3>Smart Hospitals</h3>
                    <p>Creating digitally integrated hospital ecosystems with IoT-enabled devices, predictive analytics, and automation to enhance patient care and operational efficiency.</p>
                </div>
                <div class="card">
                    <h3>Global Health Equity</h3>
                    <p>Expanding access to affordable care through mobile clinics, low-cost diagnostics, and telehealth networks that bridge the gap between urban and rural populations.</p>
                </div>
            </div>
        </div>
    </section>
