...
<head>
    ...
    <title>Manufacturing | Sarathi Cooperative</title>
    ...
    <section class="hero">
        <div class="container">
            <div class="hero-content">
                <div class="hero-text">
                    <h1>Manufacturing</h1>
                    <p class="subtitle">Optimize your manufacturing operations with tailored solutions from Sarathi Cooperative. Our experts assist with process efficiency, supply chain management, lean production, and quality control to boost productivity and reduce costs.</p>
...
$categoryName = isset($categoryName) ? $categoryName : 'Manufacturing';
