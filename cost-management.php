...
<head>
    ...
    <title>Cost Management | Sarathi Cooperative</title>
    ...
    <section class="hero">
        <div class="container">
            <div class="hero-content">
                <div class="hero-text">
                    <h1>Cost Management Services</h1>
                    <p class="subtitle">Our Cost Management experts assist in identifying inefficiencies and reducing operational costs without compromising on quality. We help you streamline your processes, manage procurement more effectively, and improve your bottom line./p>
...
$categoryName = isset($categoryName) ? $categoryName : 'Cost Management';
