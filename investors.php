...
<head>
    ...
    <title>Principal Investors & Private Equity | Sarathi Cooperative</title>
    <script type="application/ld+json">
{
   ...
   * {
    ...
    margin-top: 100px;
    padding-top: 95px;
    background: linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.1)), url('img/investment-head.avif');
...
<body>
    ...
    <section class="hero">
    <div class="container">
        <h1>Principal Investors & Private Equity</h1>
        <p>Driving growth, innovation, and value creation through strategic investments, portfolio management, and long-term capital partnerships.</p>
    </div>
</section>
...
<main class="main-content">
    ...
    <section class="section">
        <div class="container">
            ...
            <p>The principal investors and private equity industry plays a crucial role in fueling economic growth by providing capital, expertise, and strategic direction to businesses across sectors. Unlike traditional financial institutions, this sector focuses on direct investments in companies — often with the goal of transforming operations, enhancing performance, and generating strong returns over time.</p>
            <div class="content-with-image">
                <div>
                    <h3>Capital That Builds Champions</h3>
                    <p>From venture capital startups to leveraged buyouts and infrastructure funds, private equity firms and institutional investors are key enablers of business transformation. The industry has grown rapidly, supported by evolving regulatory frameworks, digital advancements, and increasing cross-border investment flows.</p>
                    <p>Valued at over $5 trillion globally, private equity supports thousands of companies, drives innovation, and contributes significantly to job creation and market competitiveness.</p>
                </div>
                <div class="image-placeholder">
                    <img src="img/investment-pic.png" alt="Boardroom meeting with investment professionals">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="grid grid-3">
                <div class="card">
                    <div class="image-placeholder small-image">
                        <img src="img/venture-capital.png" alt="Venture Capital illustration">
                    </div>
                    <h3>Venture Capital</h3>
                    <p>Early-stage funding for high-potential startups and innovative tech companies that have the potential to disrupt markets and scale rapidly.</p>
                </div>
                <div class="card">
                    <div class="image-placeholder small-image">
                        <img src="img/equity-buyout.png" alt="Private Equity Buyouts image">
                    </div>
                    <h3>Leveraged Buyouts</h3>
                    <p>Purchasing mature companies using a combination of equity and debt financing, with a focus on operational improvements and value creation.</p>
                </div>
                <div class="card">
                    <div class="image-placeholder small-image">
                        <img src="img/growth-equity.png" alt="Growth Equity concept">
                    </div>
                    <h3>Growth Equity</h3>
                    <p>Capital investments in established companies poised for expansion, helping them scale operations, enter new markets, or develop new products.</p>
                </div>
            </div>
        </div>
    </section>
...
<section class="section technologies-section">
    <div class="container">
        ...
        <div>
            <h3>Enhancing Value Through Innovation</h3>
            <p>Private equity and principal investors are increasingly leveraging data analytics and digital tools to identify opportunities, drive operational improvements, and accelerate value creation. Our technology solutions enable smarter due diligence, portfolio optimization, and post-acquisition transformation.</p>
        </div>
        
        <div class="tech-content-grid">
            <div class="tech-image-container">
                <div class="image-placeholder">
                    <img src="img/private-equity-tech.png" alt="Private Equity Technology">
                </div>
            </div>
            <div class="tech-list-container">
                <h4>Our Technology Focus Areas:</h4>
                <ul class="feature-list">
                    <li>Data-Driven Due Diligence Tools</li>
                    <li>Portfolio Performance Dashboards</li>
                    <li>AI for Market Sizing and Valuation</li>
                    <li>Operational Benchmarking Platforms</li>
                    <li>Deal Sourcing Automation</li>
                    <li>Post-Acquisition Digital Integration</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <section class="section">
        <div class="container">
            ...
            <div class="grid grid-2">
                <div class="card">
                    <div class="image-placeholder">
                        <img src="img/portfolio-management.png" alt="Portfolio management dashboard">
                    </div>
                    <h3>Portfolio Optimization</h3>
                    <p>Advanced tools and strategies to monitor, evaluate, and enhance the performance of invested assets through active ownership, operational restructuring, and exit planning.</p>
                </div>
                <div class="card">
                    <div class="image-placeholder">
                        <img src="img/esg-compliance.png" alt="ESG compliance report">
                    </div>
                    <h3>ESG & Impact Investing</h3>
                    <p>Integrating environmental, social, and governance (ESG) principles into investment decisions to drive sustainable growth and responsible capital deployment.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section">
        <div class="container">
            <h2>Future of Private Equity</h2>
            <p style="text-align: center; font-size: 1.2rem; margin-bottom: 3rem; color: #495057;">Building smarter, more responsive, and inclusive investment ecosystems through innovation, data, and foresight.</p>
            <div class="grid grid-3">
                <div class="card">
                    <h3>Decentralized Finance (DeFi)</h3>
                    <p>Exploring blockchain-based investment platforms that offer transparency, automation, and accessibility in capital allocation and fund management.</p>
                </div>
                <div class="card">
                    <h3>AI-Driven Deal Flow</h3>
                    <p>Using artificial intelligence to identify emerging trends, assess risk profiles, and generate predictive insights that guide smarter investment decisions.</p>
                </div>
                <div class="card">
                    <h3>Impact Investing Growth</h3>
                    <p>Expanding investments in climate resilience, social equity, and sustainable development projects that align profit with purpose and long-term global goals.</p>
                </div>
            </div>
        </div>
    </section>
