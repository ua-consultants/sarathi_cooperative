...
<head>
    ...
    <title>Public Sector | Sarathi Cooperative</title>
    <script type="application/ld+json">
{
  ...
  "url": "https://www.sarathicooperative.com"
    ...
    * {
        ...
        .hero {
    padding-top: 95px;
    background: linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.1)), url('img/public-head.jpeg');
...
<body>
   ...
   <section class="hero">
    <div class="container">
        <h1>Public Sector Industry</h1>
        <p>Empowering governments and civic institutions through innovative solutions, digital transformation, and sustainable infrastructure development.</p>
    </div>
</section>
...
<main class="main-content">
    ...
    <section class="section">
        <div class="container">
            ...
            <p>The public sector industry encompasses government operations, municipal services, healthcare systems, education networks, law enforcement, and national defense — all aimed at serving the public interest. This vital sector ensures the smooth functioning of society by managing essential services, enforcing laws, and driving long-term national development goals.</p>
            <div class="content-with-image">
                <div>
                    <h3>Governing the Future</h3>
                    <p>From policy implementation to infrastructure planning, the public sector continues to evolve through digital transformation, open governance initiatives, and citizen-centric service delivery. Emerging technologies like AI, blockchain, IoT, and cloud computing are revolutionizing how governments operate and interact with citizens.</p>
                    <p>With trillions of dollars invested annually worldwide, the public sector plays a central role in shaping economies, ensuring social equity, and maintaining public safety across urban and rural communities.</p>
                </div>
                <div class="image-placeholder">
                    <img src="img/city-control.png" alt="Smart city control center">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="grid grid-3">
                <div class="card">
                    <div class="image-placeholder small-image">
                        <img src="img/governance.png" alt="Governance illustration">
                    </div>
                    <h3>Government Administration</h3>
                    <p>Policy formulation, public finance management, legal frameworks, and regulatory compliance that ensure transparent and effective governance at local, state, and national levels.</p>
                </div>
                <div class="card">
                    <div class="image-placeholder small-image">
                        <img src="img/urban-infrastructure.png" alt="Urban Infrastructure image">
                    </div>
                    <h3>Infrastructure & Urban Development</h3>
                    <p>Planning and execution of transportation systems, water supply, sanitation, housing, and smart city projects that enhance quality of life and economic productivity.</p>
                </div>
                <div class="card">
                    <div class="image-placeholder small-image">
                        <img src="img/public-healthcare.png" alt="Public Healthcare concept">
                    </div>
                    <h3>Public Health & Education</h3>
                    <p>State-run hospitals, clinics, schools, and universities that provide accessible and equitable services to millions, supported by modernization efforts and digital tools.</p>
                </div>
            </div>
        </div>
    </section>
...
<section class="section technologies-section">
    <div class="container">
        ...
        <div>
            <h3>Empowering Government and Civic Innovation</h3>
            <p>Governments around the world are adopting digital technologies to improve service delivery, transparency, and citizen engagement. Our public sector solutions combine cloud computing, AI, and cybersecurity to build smarter, more responsive governance systems that meet modern challenges.</p>
        </div>
        
        <div class="tech-content-grid">
            <div class="tech-image-container">
                <div class="image-placeholder">
                    <img src="img/public-sector.png" alt="Public Sector Technology">
                </div>
            </div>
            <div class="tech-list-container">
                ...
                <ul class="feature-list">
                    ...
                    <li>Government Data Analytics</li>
                    <li>Citizen Engagement Portals</li>
                    <li>Cloud Migration for Agencies</li>
                    <li>AI for Policy Analysis</li>
                    <li>Secure Identity Management Systems</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <section class="section">
        <div class="container">
            ...
            <div class="grid grid-2">
                <div class="card">
                    <div class="image-placeholder">
                        <img src="img/public-service.png" alt="Citizen services portal">
                    </div>
                    <h3>Digital Citizen Services</h3>
                    <p>Unified platforms for e-passports, tax filing, birth certificates, licenses, and grievance redressal that make government services more accessible and efficient for citizens.</p>
                </div>
                <div class="card">
                    <div class="image-placeholder">
                        <img src="img/emergency-service.png" alt="Emergency response system">
                    </div>
                    <h3>Public Safety & Emergency Response</h3>
                    <p>Integrated command centers, real-time disaster monitoring, and rapid response systems that protect lives and property during natural or man-made crises.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section">
        <div class="container">
            <h2>Future of Public Sector</h2>
            <p style="text-align: center; font-size: 1.2rem; margin-bottom: 3rem; color: #495057;">Building smarter, more responsive, and inclusive governance through innovation, collaboration, and foresight.</p>
            <div class="grid grid-3">
                <div class="card">
                    <h3>Open Government Initiatives</h3>
                    <p>Expanding access to public data, increasing transparency, and encouraging citizen participation through open-source platforms, APIs, and participatory budgeting models.</p>
                </div>
                <div class="card">
                    <h3>Smart Cities 2.0</h3>
                    <p>Creating interconnected urban ecosystems using AI, IoT, and green infrastructure to build sustainable, livable, and future-ready cities for all.</p>
                </div>
                <div class="card">
                    <h3>AI in Governance</h3>
                    <p>Using artificial intelligence to automate administrative tasks, detect fraud, optimize resource allocation, and improve decision-making across public departments.</p>
                </div>
            </div>
        </div>
    </section>
