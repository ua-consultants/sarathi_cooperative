...
<head>
    ...
    <title>Digital Technology Data | Sarathi Cooperative</title>
    ...
    <section class="hero">
        <div class="container">
            <div class="hero-content">
                <div class="hero-text">
                    <h1>Digital Technology Data Services</h1>
                    <p class="subtitle">We enable digital transformation through data-driven strategies. From software solutions and data analytics to automation and cybersecurity, Sarathi Cooperative helps businesses harness the power of technology for smarter decision-making and improved performance.</p>
...
$categoryName = isset($categoryName) ? $categoryName : 'Digital Technology & Data';
...
<section class="blog-section">
    <div class="container blog-container">
        <div class="blog-header">
            <h2 class="blog-section-title">LBlogs: <span>Subject Expert Speaks</span></h2>
        </div>
