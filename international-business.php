...
<head>
    ...
    <title>International Business | Sarathi Cooperative</title>
        ...
        <div class="container">
            <div class="hero-content">
                <div class="hero-text">
                    ...
                    <p class="subtitle">Expand your reach globally with our International Business services. We offer support in cross-border trade, market entry strategies, regulatory navigation, and global partnerships to help you succeed in new markets.</p>
    ...
    <section class="services-overview">
        <div class="container">
            <div class="section-header">
                <h2 class="section-title">Comprehensive Advisory Solutions</h2>
                <p class="section-subtitle">From strategic planning to operational excellence, we provide end-to-end advisory services tailored to your unique business needs.</p>
            </div>
        ...
        <div class="container">
            <div class="process-container">
                <div class="process-content">
                    ...
                    <p>We follow a structured, collaborative approach to ensure our advisory services deliver maximum value and sustainable results for your organization.</p>
                </div>
...
$categoryName = isset($categoryName) ? $categoryName : 'International Business';
