...
<head>
    ...
    <title>Industrial Goods | Sarathi Cooperative</title>
    <script type="application/ld+json">
{
  ...
  "url": "https://www.sarathicooperative.com"
    ...
    * {
        ...
        .hero {
    padding-top: 95px;
    background: linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.1)), url('img/industry.webp');
...
<body>
    ...
    <section class="hero">
    <div class="container">
        <h1>Industrial Goods Industry</h1>
        <p>Pioneering high-performance industrial products, machinery, and systems that power manufacturing, infrastructure, and global supply chains.</p>
    </div>
</section>
...
<main class="main-content">
    ...
    <section class="section">
        <div class="container">
            ...
            <p>The industrial goods industry forms the backbone of modern economies, providing essential equipment, materials, and components used across manufacturing, construction, energy, transportation, and technology sectors. This sector includes everything from heavy machinery and automation systems to precision tools and industrial chemicals.</p>
            <div class="content-with-image">
                <div>
                    <h3>Driving Global Infrastructure</h3>
                    <p>From steel mills and cement plants to smart factories and logistics networks, industrial goods enable the development and operation of critical infrastructure worldwide. The industry continues to evolve with advancements in Industry 4.0, IoT-enabled systems, and sustainable manufacturing practices.</p>
                    <p>Valued at over $15 trillion globally, the industrial goods sector supports millions of jobs and contributes significantly to economic growth, innovation, and export revenues.</p>
                </div>
                <div class="image-placeholder">
                    <img src="img/automation.png" alt="Automation in industrial manufacturing">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="grid grid-3">
                <div class="card">
                    <div class="image-placeholder small-image">
                        <img src="img/machines.png" alt="Industrial machinery illustration">
                    </div>
                    <h3>Machinery & Equipment</h3>
                    <p>Design and manufacturing of industrial machines, automation systems, and robotics used in production lines, material handling, and process optimization.</p>
                </div>
                <div class="card">
                    <div class="image-placeholder small-image">
                        <img src="img/metal-minerals.png" alt="Metal manufacturing image">
                    </div>
                    <h3>Metals & Minerals</h3>
                    <p>Production of steel, aluminum, copper, and other raw materials essential for construction, automotive, electronics, and aerospace applications.</p>
                </div>
                <div class="card">
                    <div class="image-placeholder small-image">
                        <img src="img/transportation.png" alt="Supply chain concept">
                    </div>
                    <h3>Logistics & Supply Chain</h3>
                    <p>Development of warehousing systems, transport equipment, and digital tracking technologies that ensure efficient movement of goods across global markets.</p>
                </div>
            </div>
        </div>
    </section>
...
<section class="section technologies-section">
    <div class="container">
        ...
        <div>
            <h3>Building Smarter Industrial Operations</h3>
            <p>The industrial goods sector is embracing digital transformation to enhance productivity, reduce downtime, and optimize resource use. By leveraging smart manufacturing and predictive maintenance technologies, we help industrial firms achieve operational excellence and adapt to dynamic market demands.</p>
        </div>
        
        <div class="tech-content-grid">
            <div class="tech-image-container">
                <div class="image-placeholder">
                    <img src="img/industrial-yech.png" alt="Industrial Technology">
                </div>
            </div>
            <div class="tech-list-container">
                ...
                <ul class="feature-list">
                    ...
                    <li>Digital Twins for Process Simulation</li>
                    <li>Robotics and Collaborative Machines</li>
                    <li>Supply Chain Digitization Tools</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <section class="section">
        <div class="container">
            ...
            <div class="grid grid-2">
                <div class="card">
                    <div class="image-placeholder">
                        <img src="img/automated-factory.png" alt="Automated factory floor">
                    </div>
                    <h3>Smart Factory Integration</h3>
                    <p>End-to-end automation solutions that optimize production workflows, reduce operational costs, and increase output quality through real-time monitoring and AI-driven analytics.</p>
                </div>
                <div class="card">
                    <div class="image-placeholder">
                        <img src="img/materials.png" alt="Sustainable industrial materials">
                    </div>
                    <h3>Sustainable Material Production</h3>
                    <p>Eco-friendly alternatives and recycling technologies that minimize waste, lower carbon footprints, and support circular economy initiatives across the industrial value chain.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section">
        <div class="container">
            ...
            <div class="content-with-image">
                <div>
                    <h3>Precision Engineering for Industrial Components</h3>
                    <p>Our manufacturing processes combine advanced engineering, lean methodologies, and rigorous quality control to deliver high-performance industrial components and systems built to last.</p>
                    <p>We use ISO-certified production standards, automated assembly lines, and environmental compliance protocols to ensure every product meets the highest international benchmarks for durability and performance.</p>
                    <ul class="feature-list">
                        <li>ISO 9001 Certified Processes</li>
                        <li>IATF 16949 Automotive Standards</li>
                        <li>Robotic Assembly Lines</li>
                        <li>Zero-Waste Manufacturing Goals</li>
                    </ul>
                </div>
                <div class="image-placeholder">
                    <img src="img/manufacturing-line.png" alt="Industrial manufacturing facility">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section">
        <div class="container">
            <h2>Future of Industrial Goods</h2>
            <p style="text-align: center; font-size: 1.2rem; margin-bottom: 3rem; color: #495057;">Building smarter, more sustainable industries through innovation, digital transformation, and strategic collaboration.</p>
            <div class="grid grid-3">
                <div class="card">
                    <h3>Decentralized Manufacturing</h3>
                    <p>Advancing local production through 3D printing, modular design, and edge computing to reduce supply chain risks and increase flexibility.</p>
                </div>
                <div class="card">
                    <h3>Carbon-Neutral Factories</h3>
                    <p>Transitioning to net-zero operations by integrating renewable energy, green materials, and energy-efficient production techniques across all facilities.</p>
                </div>
                <div class="card">
                    <h3>Digital Industrial Platforms</h3>
                    <p>Leveraging cloud-based platforms and AI analytics to create interconnected ecosystems that enhance productivity, maintenance, and resource management across industrial operations.</p>
                </div>
            </div>
        </div>
    </section>
