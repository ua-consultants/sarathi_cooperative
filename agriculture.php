...
<head>
    ...
    <title>Agriculture | Sarathi Cooperative</title>
    <script type="application/ld+json">
{
  ...
  "url": "https://www.sarathicooperative.com"
    ...
    * {
        ...
        .hero {
    padding-top: 95px;
    background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.3)), url('img/agriculture-head.png');
...
<body>
    ...
    <section class="hero">
        <div class="container">
            ...
            <p>Driving innovation in sustainable farming, agri-tech solutions, and food security initiatives that empower farmers and feed the world.</p>
    ...
    <main class="main-content">
        ...
        <section class="section">
            <div class="container">
                ...
                <p>The agriculture industry is one of the most vital sectors globally, providing food, raw materials, and employment to billions of people. From traditional farming practices to modern precision agriculture, this sector plays a crucial role in ensuring global food security and economic development.</p>
                
                <div class="content-with-image">
                    <div>
                        <h3>Transforming Agriculture</h3>
                        <p>With rapid technological advancements and increasing demand for sustainable practices, the agriculture industry is evolving to meet modern challenges such as climate change, resource scarcity, and population growth. Smart farming technologies, data-driven decision-making, and regenerative agricultural practices are redefining how we grow and distribute food.</p>
                        <p>Valued at over $3 trillion globally, the agriculture sector supports livelihoods across rural communities while contributing significantly to national economies through exports, employment, and innovation.</p>
                    </div>
                ...
                <div class="grid grid-3">
                    <div class="card">
                        <div class="image-placeholder small-image">
                            <img src="img/crop-farming.png">
                        </div>
                        <h3>Crop Production</h3>
                        <p>Includes cultivation of staple crops, fruits, vegetables, and cash crops using modern techniques to enhance yield, reduce waste, and improve sustainability.</p>
                    </div>
                    <div class="card">
                        <div class="image-placeholder small-image">
                            <img src="img/animal-husbandry.png">
                        </div>
                        <h3>Livestock & Animal Husbandry</h3>
                        <p>Focuses on the breeding, raising, and management of livestock including cattle, poultry, and aquaculture to meet global protein demands sustainably.</p>
                    </div>
                    <div class="card">
                        <div class="image-placeholder small-image">
                            <img src="img/agri-tech.png">
                        </div>
                        <h3>Agri-Tech & Innovation</h3>
                        <p>Development of smart farming tools, IoT-enabled sensors, drone technology, and AI-powered analytics that transform how farms operate and optimize productivity.</p>
                    </div>
                </div>
            </div>
        </section>
...
<section class="section technologies-section">
    <div class="container">
        ...
        <div>
            <h3>Digital Transformation in Farming</h3>
            <p>Agriculture is undergoing a technological revolution with smart farming solutions that increase efficiency, sustainability, and yield. Our strategic integration of cutting-edge innovations empowers farmers and agribusinesses to make data-driven decisions. From precision agriculture tools to AI-powered crop monitoring systems, we're enabling smarter, scalable, and more sustainable food production.</p>
        </div>
        
        <div class="tech-content-grid">
            <div class="tech-image-container">
                <div class="image-placeholder">
                    <img src="img/agri-innovation.png" alt="Agricultural Technology">
                </div>
            </div>
            <div class="tech-list-container">
                ...
                <ul class="feature-list">
                    ...
                    <li>IoT-enabled Farm Equipment</li>
                    <li>AI Crop Monitoring Systems</li>
                    <li>Drone-based Surveillance and Spraying</li>
        ...
        <section class="section">
            <div class="container">
                ...
                <div class="grid grid-2">
                    <div class="card">
                        <div class="image-placeholder">
                            <img src="img/soil-monitoring.png">
                        </div>
                        <h3>Soil & Crop Health Monitoring</h3>
                        <p>Advanced sensors and imaging systems that assess soil composition, moisture levels, and crop health to enable real-time decision-making and optimized farm output.</p>
                    </div>
                    <div class="card">
                        <div class="image-placeholder">
                            <img src="img/water-resources.png">
                        </div>
                        <h3>Water & Resource Management</h3>
                        <p>Smart irrigation and water conservation systems that help farmers manage scarce resources efficiently and sustainably, especially in drought-prone regions.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="section">
            <div class="container">
                ...
                <p style="text-align: center; font-size: 1.2rem; margin-bottom: 3rem; color: #495057;">Shaping tomorrow’s food systems today through innovation, sustainability, and strategic partnerships.</p>
                <div class="grid grid-3">
                    <div class="card">
                        <h3>Sustainable Farming Practices</h3>
                        <p>Promoting regenerative agriculture, organic farming, and carbon-neutral practices to protect ecosystems while enhancing productivity and resilience.</p>
                    </div>
                    <div class="card">
                        <h3>Smart Supply Chains</h3>
                        <p>Integrating blockchain, IoT, and AI into supply chain logistics to improve traceability, reduce food waste, and ensure fair pricing for farmers.</p>
                    </div>
                    <div class="card">
                        <h3>Climate Resilient Crops</h3>
                        <p>Developing genetically enhanced and climate-adaptive crops that can thrive under extreme weather conditions, ensuring food security for future generations.</p>
                    </div>
                </div>
...
$categoryName = isset($categoryName) ? $categoryName : 'Automotive';
