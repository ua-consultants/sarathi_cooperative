...
<head>
    ...
    <title>Social Impact | Sarathi Cooperative</title>
    ...
    <section class="hero">
        <div class="container">
            <div class="hero-content">
                <div class="hero-text">
                    <h1>Social Impact</h1>
                    <p class="subtitle">We help organizations create lasting social value. Our Social Impact services focus on community engagement, CSR program development, and impact measurement to ensure your initiatives make a meaningful difference.</p>
...
$categoryName = isset($categoryName) ? $categoryName : 'Social Impact';
