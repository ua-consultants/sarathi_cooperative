...
<head>
    ...
    <title>Advisory Services | Sarathi Cooperative</title>
        ...
        <div class="container">
            <div class="hero-content">
                <div class="hero-text">
                    ...
                    <p class="subtitle">Navigate complex business challenges with confidence. Our experienced advisors provide strategic guidance, industry expertise, and actionable insights to accelerate your growth.</p>
    ...
    <section class="services-overview">
        <div class="container">
            <div class="section-header">
                ...
                <p class="section-subtitle">From strategic planning to operational excellence, we provide end-to-end Cost Management services tailored to your unique business needs.</p>
            </div>
            ...
            <div class="services-grid">
                ...
                <div class="service-card">
                    ...
                    <p class="service-description">Build high-performing teams and organizational capabilities. Our HR advisory services help you attract, develop, and retain top talent.</p>
                    <ul class="service-features">
...
$categoryName = isset($categoryName) ? $categoryName : 'Advisory';
...
try {
    ...
    if ($category) {
        // Fetch published blogs for this category (limit to 6 for display)
        $blogsStmt = $pdo->prepare("
            SELECT id, title, slug, excerpt, featured_image, published_at, author_name, meta_keywords
            FROM blogs 
        ...
        $countStmt = $pdo->prepare("SELECT COUNT(*) FROM blogs WHERE category_id = ? AND status = 'published'");
...
<section class="blog-section">
    <div class="container blog-container">
        <div class="blog-header">
            <h2 class="blog-section-title">Blogs: <span>Subject Experts Speak</span></h2>
            <!--<div class="blog-stats">-->
            <!--    <div class="blog-stats-item">-->
            <!--        📚 <span class="blog-stats-number"><?php echo $totalBlogs; ?></span> Articles-->
            <!--    </div>-->
            <!--    <div class="blog-stats-item">-->
            <!--        🎯 <span class="blog-stats-number"><?php echo htmlspecialchars($categoryName); ?></span> Focus-->
            <!--    </div>-->
            <!--</div>-->
        </div>
