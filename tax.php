...
<head>
    ...
    <title>Tax | Sarathi Cooperative</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <section class="hero">
        <div class="container">
            <div class="hero-content">
                <div class="hero-text">
                    <h1>Tax</h1>
                    <p class="subtitle">Our Tax services ensure compliance, minimize liabilities, and uncover savings opportunities. We offer personal and corporate tax planning, return preparation, and advisory services to help you stay ahead of tax obligations and take full advantage of applicable incentives.</p>
