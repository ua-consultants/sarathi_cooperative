...
<head>
    ...
    <title>Climate Change Services | Sarathi Cooperative</title>
    ...
    <section class="hero">
        <div class="container">
            <div class="hero-content">
                <div class="hero-text">
                    <h1>Climate Change and Sustainability Services</h1>
                    <p class="subtitle">We support organizations in integrating environmentally responsible practices into their operations. Our Climate Change and Sustainability services include carbon footprint assessments, ESG reporting, and strategies for transitioning to a low-carbon economy while maintaining profitability.</p>
    ...
    <section class="services-overview">
        <div class="container">
            <div class="section-header">
                <h2 class="section-title">Comprehensive Solutions for Sustainability</h2>
                <p class="section-subtitle">From strategic planning to operational excellence, we provide end-to-end advisory services tailored to Climate Change and Sustainability needs.</p>
            </div>
            ...
            <div class="services-grid">
                <div class="service-card">
                    ...
                    <p class="service-description">Develop comprehensive business strategies that align with your vision and climate control. Our experts help you navigate competitive landscapes and identify growth pathways.</p>
...
$categoryName = isset($categoryName) ? $categoryName : 'Climate Change & Sustaibability';
