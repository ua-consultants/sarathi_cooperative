...
<head>
    ...
    <title>Insurance | Sarathi Cooperative</title>
    <script type="application/ld+json">
{
  ...
  "url": "https://www.sarathicooperative.com"
    ...
    * {
        ...
        .hero {
    padding-top: 95px;
    background: linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.1)), url('img/insurance-head.jpg');
...
<body>
    ...
    <div class="container">
        ...
        <p>Providing risk protection and financial security through innovative insurance products, digital underwriting, and customer-centric claims management.</p>
    </div>
</section>
...
<main class="main-content">
    ...
    <section class="section">
        <div class="container">
            ...
            <p>The insurance industry plays a vital role in managing risk and offering financial protection to individuals, families, and businesses. It encompasses life, health, property, casualty, auto, and specialty insurance solutions designed to mitigate uncertainties and provide peace of mind in an unpredictable world.</p>
            <div class="content-with-image">
                <div>
                    <h3>Driving Security & Stability</h3>
                    <p>This essential sector continuously evolves with advancements in data analytics, AI-driven underwriting, telematics, and digital claims processing. Insurtech innovations are transforming how policies are created, priced, and serviced — making insurance more accessible, personalized, and efficient than ever before.</p>
                    <p>Valued at over $6 trillion globally, the insurance industry supports economic resilience by helping individuals recover from loss and enabling businesses to operate confidently in dynamic environments.</p>
                </div>
                <div class="image-placeholder">
                    <img src="img/family-insurance.png" alt="Insurance claim processing dashboard">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="grid grid-3">
                <div class="card">
                    <div class="image-placeholder small-image">
                        <img src="img/insurance-illustration.png" alt="Life insurance illustration">
                    </div>
                    <h3>Life Insurance</h3>
                    <p>Protection plans that provide financial security to dependents in the event of policyholder’s death. Includes term, whole life, and investment-linked insurance products.</p>
                </div>
                <div class="card">
                    <div class="image-placeholder small-image">
                        <img src="img/general-insurance.png" alt="General insurance image">
                    </div>
                    <h3>General Insurance</h3>
                    <p>Covers assets and liabilities such as home, vehicle, travel, and commercial property insurance. Also includes liability and personal accident coverage.</p>
                </div>
                <div class="card">
                    <div class="image-placeholder small-image">
                        <img src="img/health-insurance.png" alt="Health insurance concept">
                    </div>
                    <h3>Health Insurance</h3>
                    <p>Medical expense coverage including hospitalization, outpatient care, preventive services, and wellness programs. Focuses on accessibility, affordability, and integrated care delivery.</p>
                </div>
            </div>
        </div>
    </section>
...
<section class="section technologies-section">
    <div class="container">
        ...
        <div>
            <h3>Modernizing Risk and Coverage</h3>
            <p>Insurance is evolving with data-driven underwriting, automated claims processing, and real-time risk assessment tools. Our technology initiatives help insurers streamline operations, personalize policies, and enhance fraud detection while improving customer satisfaction and regulatory compliance.</p>
        </div>
        
        <div class="tech-content-grid">
            <div class="tech-image-container">
                <div class="image-placeholder">
                    <img src="img/insurance-tech.png" alt="Insurance Technology">
                </div>
            </div>
            <div class="tech-list-container">
                <h4>Our Technology Focus Areas:</h4>
                <ul class="feature-list">
                    <li>Telematics for Usage-Based Insurance</li>
                    <li>Claims Automation with AI</li>
                    <li>Customer Analytics Platforms</li>
                    <li>InsurTech Platforms for Distribution</li>
                    <li>Cyber Risk Assessment Tools</li>
                    <li>Parametric Insurance Models</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <section class="section">
        <div class="container">
            ...
            <div class="grid grid-2">
                <div class="card">
                    <div class="image-placeholder">
                        <img src="img/digital-policy.png" alt="Digital insurance policy dashboard">
                    </div>
                    <h3>Digital Policy Administration</h3>
                    <p>End-to-end platforms for policy creation, renewal, premium calculation, and customer interaction — all delivered through mobile apps and online portals for seamless user experience.</p>
                </div>
                <div class="card">
                    <div class="image-placeholder">
                        <img src="img/fraud-detection.png" alt="Fraud detection system interface">
                    </div>
                    <h3>Fraud Detection Systems</h3>
                    <p>AI-powered tools that analyze patterns, detect anomalies, and flag suspicious claims to protect insurers and policyholders from financial losses due to fraudulent activities.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section">
        <div class="container">
            ...
            <p style="text-align: center; font-size: 1.2rem; margin-bottom: 3rem; color: #495057;">Building smarter, more responsive, and inclusive insurance ecosystems through innovation, data, and foresight.</p>
            <div class="grid grid-3">
                <div class="card">
                    <h3>Usage-Based Insurance</h3>
                    <p>Personalized policies tailored to individual behavior and usage patterns using telematics, wearables, and real-time data insights for fairer pricing and better risk assessment.</p>
                </div>
                <div class="card">
                    <h3>Parametric Insurance</h3>
                    <p>Automated payouts triggered by predefined events (e.g., weather conditions or seismic activity), reducing claim processing time and increasing transparency.</p>
                </div>
                <div class="card">
                    <h3>Climate Risk Insurance</h3>
                    <p>Expanding coverage for climate-related risks including floods, droughts, wildfires, and extreme weather events to support resilience and sustainability goals.</p>
                </div>
            </div>
        </div>
    </section>
