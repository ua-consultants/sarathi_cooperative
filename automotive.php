...
<head>
    ...
    <title>Automotive | Sarathi Cooperative</title>
    <script type="application/ld+json">
{
  ...
  "url": "https://www.sarathicooperative.com"
    ...
    * {
       ...
       .hero {
    padding-top: 95px;
    background: linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.1)), url('img/electric-cars.png');
...
<body>
    ...
    <div class="container">
        ...
        <p>Powering the future of mobility with cutting-edge automotive engineering, electric vehicles, and intelligent transportation systems.</p>
    </div>
</section>
...
<main class="main-content">
    ...
    <section class="section">
        <div class="container">
            ...
            <p>The automotive industry is one of the largest and most dynamic sectors globally, driving innovation in vehicle design, manufacturing, and mobility solutions. From traditional internal combustion engines to electric and autonomous vehicles, the industry continues to evolve rapidly to meet changing consumer demands and environmental regulations.</p>
            <div class="content-with-image">
                <div>
                    <h3>Mobility Revolution</h3>
                    <p>The global automotive market is undergoing a transformation fueled by electrification, connectivity, and automation. With over 90 million vehicles produced annually, the sector remains a cornerstone of economic growth and technological advancement across the world.</p>
                    <p>From passenger cars and commercial vehicles to advanced driver-assistance systems (ADAS), the automotive industry plays a critical role in shaping how people and goods move in the 21st century.</p>
                </div>
                <div class="image-placeholder">
                    <img src="img/car.png" alt="Electric car charging station">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="grid grid-3">
                <div class="card">
                    <div class="image-placeholder small-image">
                        <img src="img/car-illustration.png" alt="Electric vehicle illustration">
                    </div>
                    <h3>Electric Vehicles (EVs)</h3>
                    <p>Design and production of battery-powered vehicles that reduce carbon emissions and dependence on fossil fuels. Includes EV platforms, battery systems, and fast-charging infrastructure.</p>
                </div>
                <div class="card">
                    <div class="image-placeholder small-image">
                        <img src="img/autonomous.png" alt="Autonomous driving technology">
                    </div>
                    <h3>Autonomous Driving</h3>
                    <p>Development of self-driving technologies using AI, machine learning, and sensor fusion to enable safer, smarter, and more efficient transportation systems.</p>
                </div>
                <div class="card">
                    <div class="image-placeholder small-image">
                        <img src="img/mobility.png" alt="Smart mobility concept">
                    </div>
                    <h3>Connected Mobility</h3>
                    <p>Integration of IoT, telematics, and cloud-based platforms to enhance vehicle performance, user experience, and fleet management capabilities.</p>
                </div>
            </div>
        </div>
    </section>
...
<section class="section technologies-section">
    <div class="container">
        ...
        <div>
            <h3>Driving the Future of Mobility</h3>
            <p>The automotive industry is rapidly evolving with breakthroughs in electrification, autonomy, and connectivity. We lead the charge in integrating advanced technologies that redefine vehicle performance, safety, and user interaction. Our innovations span from electric powertrains to intelligent transportation systems, shaping the future of mobility.</p>
        </div>
        
        <div class="tech-content-grid">
            <div class="tech-image-container">
                <div class="image-placeholder">
                    <img src="img/ai-car.png" alt="Automotive Technology">
                </div>
            </div>
            <div class="tech-list-container">
                <h4>Our Technology Focus Areas:</h4>
                <ul class="feature-list">
                    <li>Electric Vehicle Powertrain Systems</li>
                    <li>Autonomous Driving Platforms</li>
                    <li>V2X (Vehicle-to-Everything) Communication</li>
                    <li>Connected Car Ecosystems</li>
                    <li>Battery Management Innovations</li>
    ...
    <section class="section">
        <div class="container">
            ...
            <div class="grid grid-2">
                <div class="card">
                    <div class="image-placeholder">
                        <img src="img/adas-dashboard.png" alt="ADAS system dashboard">
                    </div>
                    <h3>Advanced Safety Systems</h3>
                    <p>Intelligent driver assistance features such as automatic emergency braking, lane keeping assist, adaptive cruise control, and blind-spot monitoring to enhance road safety and reduce accidents.</p>
                </div>
                <div class="card">
                    <div class="image-placeholder">
                        <img src="img/fleet-management.png" alt="Fleet management dashboard">
                    </div>
                    <h3>Fleet & Logistics Management</h3>
                    <p>Integrated telematics and GPS tracking systems that optimize vehicle routing, fuel efficiency, maintenance scheduling, and operational costs for commercial fleets.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section">
        <div class="container">
            ...
            <div class="content-with-image">
                <div>
                    <h3>Precision Engineering & Lean Production</h3>
                    <p>Our automotive manufacturing processes combine high-tech automation with lean methodologies to ensure top-tier quality, efficiency, and scalability.</p>
                    <p>We employ state-of-the-art robotics, precision tooling, and rigorous testing protocols to deliver components and vehicles that meet the highest international standards.</p>
                    <ul class="feature-list">
                        <li>IATF 16949 Quality Certification</li>
                ...
                <div class="image-placeholder">
                    <img src="img/cars-manufacturing.png" alt="Automotive manufacturing plant">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section">
        <div class="container">
            ...
            <p style="text-align: center; font-size: 1.2rem; margin-bottom: 3rem; color: #495057;">Driving the next generation of mobility through innovation, sustainability, and smart integration.</p>
            <div class="grid grid-3">
                <div class="card">
                    <h3>Sustainable Transportation</h3>
                    <p>Accelerating the shift toward zero-emission vehicles, circular economy practices, and eco-friendly manufacturing to reduce environmental impact.</p>
                </div>
                <div class="card">
                    <h3>Smart Cities Integration</h3>
                    <p>Developing intelligent transport systems, shared mobility platforms, and urban mobility networks to support future smart city infrastructures.</p>
                </div>
                <div class="card">
                    <h3>Hyperconnectivity & Cybersecurity</h3>
                    <p>Building secure, connected vehicle ecosystems with end-to-end cybersecurity measures to protect data, privacy, and system integrity.</p>
                </div>
            </div>
        </div>
    </section>
