...
<head>
    ...
    <title>Education | Sarathi Cooperative</title>
    <script type="application/ld+json">
{
  ...
  "url": "https://www.sarathicooperative.com"
    ...
    * {
        ...
        .hero {
    padding-top: 95px;
    background: linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.1)), url('img/modern-classroom.png');
...
<body>
    ...
    <div class="container">
        ...
        <p>Empowering learners of all ages with innovative educational tools, digital learning platforms, and future-ready skill development solutions.</p>
        <!--<div class="hero-image large-image">-->
        <!--    <img src="img/modern-classroom.png" alt="Modern classroom with students using tablets and laptops">-->
        <!--</div>-->
    </div>
</section>
...
<main class="main-content">
    ...
    <section class="section">
        <div class="container">
            ...
            <p>The education industry is a cornerstone of global development, shaping minds, building futures, and driving innovation across generations. From early childhood learning to higher education and lifelong professional training, this sector plays a transformative role in individual growth and societal progress.</p>
            <div class="content-with-image">
                <div>
                    <h3>Learning Revolution</h3>
                    <p>In today’s rapidly evolving world, education is being redefined by technology, accessibility, and personalized learning experiences. Digital classrooms, AI-driven tutoring systems, and immersive learning environments are making quality education more inclusive and effective than ever before.</p>
                    <p>Valued at over $6 trillion globally, the education industry supports millions of educators, institutions, and learners while continuously adapting to meet new challenges and opportunities in the digital age.</p>
                </div>
                <div class="image-placeholder">
                    <img src="img/student.png" alt="Students collaborating in a modern learning environment">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="grid grid-3">
                <div class="card">
                    <div class="image-placeholder small-image">
                        <img src="img/school-illustration.png" alt="School education illustration">
                    </div>
                    <h3>K-12 & School Education</h3>
                    <p>Curriculum design, teaching tools, digital learning platforms, and infrastructure support for primary and secondary schools that foster foundational knowledge and creativity.</p>
                </div>
                <div class="card">
                    <div class="image-placeholder small-image">
                        <img src="img/university-illustration.png" alt="University campus image">
                    </div>
                    <h3>Higher Education & Research</h3>
                    <p>Supporting universities, colleges, and research institutions with advanced academic resources, laboratory equipment, online learning systems, and collaborative research platforms.</p>
                </div>
                <div class="card">
                    <div class="image-placeholder small-image">
                        <img src="img/elearning.png" alt="eLearning platform concept">
                    </div>
                    <h3>eLearning & Digital Learning</h3>
                    <p>Development of virtual classrooms, mobile learning apps, LMS (Learning Management Systems), and AI-based personalization tools that make education accessible anytime, anywhere.</p>
                </div>
            </div>
        </div>
    </section>
...
<section class="section technologies-section">
    <div class="container">
        ...
        <div>
            <h3>Transforming Learning Through Technology</h3>
            <p>Education is being redefined by digital innovation, offering personalized, accessible, and immersive learning experiences. We harness emerging technologies to support educators, institutions, and learners in adapting to a rapidly changing world. Our solutions enhance engagement, improve outcomes, and foster lifelong learning.</p>
        </div>
        
        <div class="tech-content-grid">
            <div class="tech-image-container">
                <div class="image-placeholder">
                    <img src="img/edu-tech.png" alt="Education Technology">
                </div>
            </div>
            <div class="tech-list-container">
                ...
                <ul class="feature-list">
                    ...
                    <li>Learning Analytics Tools</li>
                    <li>Blockchain-Based Credential Verification</li>
                    <li>Mobile and Cloud-Based Learning Systems</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <section class="section">
        <div class="container">
            ...
            <div class="grid grid-2">
                <div class="card">
                    <div class="image-placeholder">
                        <img src="img/e-dashboard.png" alt="Learning Management System dashboard">
                    </div>
                    <h3>Digital Learning Platforms</h3>
                    <p>Scalable, secure, and interactive e-learning platforms that support remote instruction, real-time collaboration, and performance tracking for students and educators alike.</p>
                </div>
                <div class="card">
                    <div class="image-placeholder">
                        <img src="img/ai-tutor.png" alt="AI-powered tutoring system">
                    </div>
                    <h3>Personalized Learning Systems</h3>
                    <p>AI-driven tutoring and adaptive learning tools that customize curriculum based on student performance, preferences, and learning pace to maximize engagement and outcomes.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section">
        <div class="container">
            ...
            <div class="content-with-image">
                <div>
                    <h3>Precision Engineering for Educational Technology</h3>
                    <p>Our manufacturing processes ensure high-quality production of educational hardware — from smartboards and tablets to lab equipment and robotics kits — built to last and perform in diverse learning environments.</p>
                    <p>We follow strict quality control protocols and sustainability practices to deliver reliable, durable, and safe products that meet international standards for educational use.</p>
                    <ul class="feature-list">
                        <li>ISO 9001 Certified Processes</li>
                        <li>EdTech Product Certification Standards</li>
                        <li>Automated Assembly Lines</li>
                        <li>Eco-Friendly Production Practices</li>
                    </ul>
                </div>
                <div class="image-placeholder">
                    <img src="img/ed-tech.png" alt="EdTech manufacturing line">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section">
        <div class="container">
            ...
            <p style="text-align: center; font-size: 1.2rem; margin-bottom: 3rem; color: #495057;">Building tomorrow’s learners today through innovation, inclusivity, and intelligent systems.</p>
            <div class="grid grid-3">
                <div class="card">
                    <h3>Accessible Education</h3>
                    <p>Expanding access to education through affordable digital tools, open-source learning materials, and multilingual platforms that bridge the global education gap.</p>
                </div>
                <div class="card">
                    <h3>Hybrid Learning Models</h3>
                    <p>Creating seamless integration between physical and digital learning environments to provide flexible, engaging, and future-proof educational experiences.</p>
                </div>
                <div class="card">
                    <h3>Skill Development for Tomorrow</h3>
                    <p>Focusing on STEM, coding, AI literacy, and soft skills training to prepare students for the evolving demands of the workforce and innovation economy.</p>
                </div>
            </div>
        </div>
    </section>
