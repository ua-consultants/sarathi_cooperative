...
<head>
    ...
    <title>Consumer Products | Sarathi Cooperative</title>
    <script type="application/ld+json">
{
  ...
  "url": "https://www.sarathicooperative.com"
    ...
    * {
        ...
        .hero {
    padding-top: 95px;
    background: linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.1)), url('img/consumer.png');
...
<body>
    ...
    <section class="hero">
    <div class="container">
        <h1>Consumer Products Industry</h1>
        <p>Innovating everyday life with high-quality consumer goods that enhance convenience, comfort, and lifestyle across global markets.</p>
    </div>
</section>
...
<main class="main-content">
    ...
    <section class="section">
        <div class="container">
            ...
            <p>The consumer products industry is one of the most dynamic and customer-focused sectors in the global economy. It encompasses a wide range of everyday goods — from food and beverages to personal care items, home appliances, and fashion — that touch millions of lives daily.</p>
            <div class="content-with-image">
                <div>
                    <h3>Daily Innovation</h3>
                    <p>This fast-paced industry thrives on innovation, sustainability, and evolving consumer preferences. Brands are continuously adapting to digital transformation, supply chain optimization, and eco-conscious production methods to meet growing demand in both developed and emerging markets.</p>
                    <p>Valued at over $10 trillion globally, the consumer products sector plays a vital role in economic growth, employment, and technological advancement, influencing everything from retail trends to environmental policies.</p>
                </div>
                <div class="image-placeholder">
                    <img src="img/family.png" alt="Family browsing consumer products">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="grid grid-3">
                <div class="card">
                    <div class="image-placeholder small-image">
                        <img src="img/food-illustration.png" alt="Food and beverage illustration">
                    </div>
                    <h3>Food & Beverages</h3>
                    <p>Production of packaged foods, drinks, and nutrition products designed for health, convenience, and flavor. Includes organic, plant-based, and functional foods.</p>
                </div>
                <div class="card">
                    <div class="image-placeholder small-image">
                        <img src="img/personal-care.png" alt="Personal care products image">
                    </div>
                    <h3>Personal Care & Cosmetics</h3>
                    <p>Skincare, haircare, hygiene, and beauty products tailored to modern lifestyles and ethical standards like cruelty-free and clean beauty.</p>
                </div>
                <div class="card">
                    <div class="image-placeholder small-image">
                        <img src="img/home-appliances.png" alt="Home appliance concept">
                    </div>
                    <h3>Home & Lifestyle Goods</h3>
                    <p>Furniture, kitchenware, electronics, and decor products that blend functionality with aesthetic appeal to enrich everyday living spaces.</p>
                </div>
            </div>
        </div>
    </section>
...
<section class="section technologies-section">
    <div class="container">
        ...
        <div>
            <h3>Innovation in Product Development</h3>
            <p>The consumer products industry thrives on innovation, driven by evolving customer expectations and digital transformation. We leverage advanced technologies to streamline design, manufacturing, and distribution processes while enhancing personalization and user experience. Our focus is on building agile, tech-integrated supply chains and intelligent product ecosystems.</p>
        </div>
        
        <div class="tech-content-grid">
            <div class="tech-image-container">
                <div class="image-placeholder">
                    <img src="img/smart-appliances.png" alt="Consumer Products Technology">
                </div>
            </div>
            <div class="tech-list-container">
                <h4>Our Technology Focus Areas:</h4>
                <ul class="feature-list">
                    <li>Augmented Reality (AR) for Product Experience</li>
                    <li>AI-Driven Demand Forecasting</li>
                    <li>Smart Packaging Solutions</li>
                    <li>3D Printing for Rapid Prototyping</li>
                    <li>Sustainable Manufacturing Tech</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <section class="section">
        <div class="container">
            ...
            <div class="grid grid-2">
                <div class="card">
                    <div class="image-placeholder">
                        <img src="img/friendly-packaging.png" alt="Eco-friendly packaging">
                    </div>
                    <h3>Sustainable Packaging</h3>
                    <p>Innovative biodegradable, recyclable, and reusable packaging solutions that reduce plastic waste and support circular economy initiatives while maintaining product integrity and shelf appeal.</p>
                </div>
                <div class="card">
                    <div class="image-placeholder">
                        <img src="img/ecommerce.png" alt="Digital retail dashboard">
                    </div>
                    <h3>E-Commerce Integration</h3>
                    <p>Seamless integration with digital marketplaces, personalized shopping experiences, and real-time inventory systems that optimize online sales and customer engagement.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section">
        <div class="container">
            ...
            <div class="content-with-image">
                <div>
                    <h3>Precision Engineering for Consumer Goods</h3>
                    <p>Our manufacturing processes combine automation, lean methodologies, and sustainable practices to deliver high-volume, high-quality consumer products efficiently and responsibly.</p>
                    <p>We use advanced robotics, AI-driven quality control, and eco-conscious materials to ensure every product meets the highest international standards while minimizing environmental impact.</p>
                    <ul class="feature-list">
                        <li>ISO 9001 Quality Management</li>
                        <li>LEAN Manufacturing Principles</li>
                        <li>Automated Production Lines</li>
                        <li>Clean & Ethical Production Standards</li>
                    </ul>
                </div>
                <div class="image-placeholder">
                    <img src="img/manufacturing.png" alt="Consumer product manufacturing line">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section">
        <div class="container">
            <h2>Future of Consumer Products</h2>
            <p style="text-align: center; font-size: 1.2rem; margin-bottom: 3rem; color: #495057;">Creating smarter, more sustainable products that anticipate tomorrow’s needs today through innovation and insight.</p>
            <div class="grid grid-3">
                <div class="card">
                    <h3>Zero-Waste Production</h3>
                    <p>Advancing circular economy models by designing products and packaging that minimize waste and maximize reusability across the value chain.</p>
                </div>
                <div class="card">
                    <h3>Hyper-Personalization</h3>
                    <p>Leveraging data analytics and AI to create customized products that cater to individual preferences, from skincare routines to smart home integrations.</p>
                </div>
                <div class="card">
                    <h3>Transparent Supply Chains</h3>
                    <p>Implementing blockchain and IoT-enabled traceability systems to build trust and transparency in sourcing, manufacturing, and delivery processes.</p>
                </div>
            </div>
        </div>
    </section>
