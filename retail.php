...
<head>
    ...
    <title>Retail Industry | Sarathi Cooperative</title>
    <script type="application/ld+json">
{
   ...
   * {
        ...
        .hero {
    padding-top: 95px;
    background: linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.1)), url('img/retail-head.png');
...
<body>
    ...
    <div class="container">
        ...
        <p>Transforming the shopping experience with omnichannel innovation, smart supply chains, and customer-centric commerce solutions.</p>
    </div>
</section>
...
<main class="main-content">
    ...
    <section class="section">
        <div class="container">
            ...
            <p>The retail industry is one of the most dynamic and customer-facing sectors in the global economy. It encompasses a wide range of businesses — from brick-and-mortar stores and e-commerce platforms to wholesale distributors and logistics providers — all focused on delivering products and services directly to consumers.</p>
            <div class="content-with-image">
                <div>
                    <h3>Evolving Commerce</h3>
                    <p>In today’s fast-paced world, the retail landscape is being transformed by digital innovation, personalization, and seamless customer experiences. From AI-driven recommendations to contactless payments and smart inventory systems, retailers are leveraging technology to meet changing consumer expectations and optimize operations.</p>
                    <p>Valued at over $25 trillion globally, the retail sector plays a vital role in employment, economic growth, and technological advancement, shaping how people shop and interact with brands worldwide.</p>
                </div>
                <div class="image-placeholder">
                    <img src="img/omnichanel-retail.png" alt="Omnichannel retail experience">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="grid grid-3">
                <div class="card">
                    <div class="image-placeholder small-image">
                        <img src="img/e-commerce.png" alt="E-commerce illustration">
                    </div>
                    <h3>E-Commerce</h3>
                    <p>Online marketplaces, mobile shopping apps, and digital storefronts that enable seamless transactions and personalized shopping experiences across devices.</p>
                </div>
                <div class="card">
                    <div class="image-placeholder small-image">
                        <img src="img/brick-illustration.png" alt="Brick and mortar store image">
                    </div>
                    <h3>Brick & Mortar Retail</h3>
                    <p>Physical stores including department stores, supermarkets, specialty shops, and pop-up locations that provide immersive and interactive shopping environments.</p>
                </div>
                <div class="card">
                    <div class="image-placeholder small-image">
                        <img src="img/supply-chain.png" alt="Supply chain concept">
                    </div>
                    <h3>Logistics & Distribution</h3>
                    <p>Warehousing, fulfillment centers, last-mile delivery, and reverse logistics systems that ensure timely and efficient product movement across global markets.</p>
                </div>
            </div>
        </div>
    </section>
...
<section class="section technologies-section">
    <div class="container">
        ...
        <div>
            <h3>Reinventing the Shopping Experience</h3>
            <p>Retail is being transformed by omnichannel commerce, personalization, and automation. We deploy innovative technologies that enhance customer engagement, optimize inventory, and streamline operations across physical and digital touchpoints, helping retailers thrive in a competitive landscape.</p>
        </div>
        
        <div class="tech-content-grid">
            <div class="tech-image-container">
                <div class="image-placeholder">
                    <img src="img/retail-tech.png" alt="Retail Technology">
                </div>
            </div>
            <div class="tech-list-container">
                ...
                <ul class="feature-list">
                    ...
                    <li>Robotic Store Assistants</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <section class="section">
        <div class="container">
            ...
            <div class="grid grid-2">
                <div class="card">
                    <div class="image-placeholder">
                        <img src="img/pos-system.png" alt="Point of sale system">
                    </div>
                    <h3>Omnichannel POS Integration</h3>
                    <p>Unified point-of-sale (POS) systems that seamlessly connect online and offline channels, enabling real-time inventory tracking, customer insights, and smooth checkout experiences.</p>
                </div>
                <div class="card">
                    <div class="image-placeholder">
                        <img src="img/customer-analytics.png" alt="Customer analytics dashboard">
                    </div>
                    <h3>Predictive Customer Analytics</h3>
                    <p>AI-driven tools that analyze buying behavior, predict trends, and personalize marketing strategies to increase customer retention and lifetime value.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section">
        <div class="container">
            ...
            <p style="text-align: center; font-size: 1.2rem; margin-bottom: 3rem; color: #495057;">Building smarter, more responsive, and inclusive retail ecosystems through innovation, data, and foresight.</p>
            <div class="grid grid-3">
                <div class="card">
                    <h3>Hyper-Personalized Shopping</h3>
                    <p>Creating individualized shopping journeys using AI, facial recognition, and behavioral data to offer tailored product suggestions and promotions.</p>
                </div>
                <div class="card">
                    <h3>Metaverse Commerce</h3>
                    <p>Exploring virtual and augmented reality shopping environments where customers can browse, try, and purchase products in immersive digital spaces.</p>
                </div>
                <div class="card">
                    <h3>Zero-Waste Retail Models</h3>
                    <p>Advancing sustainable practices through circular economy initiatives, reusable packaging, and local sourcing to reduce environmental impact.</p>
                </div>
            </div>
        </div>
    </section>
